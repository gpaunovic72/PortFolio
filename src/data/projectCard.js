...
import EsthetiqueCar72_contact from "../assets/esthetiquecar72_contact.webp";
import EsthetiqueCar72_response from "../assets/esthetiquecar72_response.webp";
...
export const cards = [
  {
    id: 8,
    title: "Esthétique Car 72",
    date: "2025",
    stacks: [
      { color: "#E34C26", stack: "HTML" },
      { color: "#663399", stack: "CSS" },
      { color: "#F1E05A", stack: "Javascript" },
      { color: "#FF0000", stack: "Adobe Muse" },
    ],
    picture: [EsthetiqueCar72_contact, EsthetiqueCar72_response],
    description:
      "Diagnostic d'un formulaire HTML/JS non fonctionnel sur un site Adobe Muse. \n\n Suppression de sections HTML dupliquées et nettoyage du script. \n\n Résolution d'une erreur HierarchyRequestError liée au DOM. \n\n Ajout d'un fallback pour les ressources manquantes. \n\n Rétablissement complet de l'envoi des messages via le formulaire. \n\n Création d'une page de confirmation personnalisée pour améliorer l'expérience utilisateur après envoi d'email.",
    lien: "https://www.esthetiquecar72.fr/contact.html",
  },
  {
    id: 7,
    ...
    description:
      "Refonte complète du site vitrine sous WordPress pour améliorer l'UX, la performance et la structure SEO. \n\n Personnalisation du thème, ajout de fonctionnalités spécifiques et optimisation des médias. \n\n Réécriture des balises meta et structuration sémantique du contenu. ",
  ...
  },
  {
    ...
    description:
      "Développement d'une application e-commerce complète avec gestion du panier pour utilisateurs connectés et non connectés (sessionId).\n\n Création d'une API REST avec Next.js App Router et Prisma.\n\n Authentification sécurisée via JWT, stockage des données sur MySQL.\n\n Séparation claire du Frontend et Backend pour une architecture maintenable.",
  ...
  },
  {
    ...
    description:
      "Conception d'un portfolio responsive et interactif. \n\n Utilisation de useMemo pour améliorer la gestion et le rendu dynamique des expériences. \n\n Développement d'un affichage visuel des périodes d'activité à l'aide d'un système de surlignage automatique par date.",
